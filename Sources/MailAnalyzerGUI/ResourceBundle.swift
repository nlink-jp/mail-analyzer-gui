...
/// Locates the SwiftPM-generated resource bundle
/// (`MailAnalyzerGUI_MailAnalyzerGUI.bundle`) at runtime.
///
...
/// anywhere else (zip-porter shipped that crash through v0.10.0).
...
extension Bundle {
    ...
    static let appResources = ResourceBundleLocator.resolve(
        bundleName: "MailAnalyzerGUI_MailAnalyzerGUI")
}
